...
FEATURE_SQL_QUERIES={
    ...
    'AIRWAYS':('''select A.route_id, A.sequence, A.longitude, A.latitude,A.fix_section_code,A.fix_subsection_code,A.outbound_mag_course,A.inbound_mag_course,A.description_code,A.minimum_altitude from airway A order by A.route_id,A.sequence where A.fix_id = '%s' ''',{
        'name':0,
        'sequence':1,
        'longitude':2,
        'latitude':3,
